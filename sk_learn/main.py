...
# 1. Load the dataset
housing = pd.read_csv(r"C:\Users\LENOVO\.cursor\python_oneshot\sk_learn\housing.csv")
...
print(f"The cross_val_score for Linear Regression is {lin_rmses}")
...
print(f"The cross_val_score error for Decision Tree is {dec_rmses}")
...
print(f"The root cross_val_score error for Random Forest is {random_forest_rmses}")
